...
<!-- Mirrored from restroking.dexignzone.com/xhtml/shop-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 08:09:40 GMT -->
...
<body id="bg" class="leftsidebar">
    <div class="page-wraper">
                    ...
                    <div class="container clearfix">
                        ...
                        <div class="header-nav navbar-collapse collapse justify-content-between" id="navbarNavDropdown">
                            ...
                            <ul class="nav navbar-nav nav1">
                                ...
                                <li><a href="javascript:void(0);">Pages<i class="fa fa-chevron-down"></i></a>
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);">Contact Us <i
                            ...
                            <ul class="nav navbar-nav nav2">
                                ...
                                <li class="has-mega-menu"><a href="javascript:void(0);">Blog<i
                                            class="fa fa-chevron-down"></i></a>
                                    <ul class="mega-menu">
                                        <li> <a href="javascript:;">Blog Grid</a>
                                            <ul>
                                                ...
                                                <li><a href="blog-grid-2-sidebar-left.html">Grid 2 sidebar left</a>
                                                </li>
                                        ...
                                        <li> <a href="javascript:;">Blog Details</a>
                                            <ul>
                                                ...
                                                <li><a href="blog-single-left-sidebar.html">Single sidebar right</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                            ...
                            <div class="p-a30 border-1 max-w500 m-auto radius-sm">
                                <div class="tab-content">
                                    <form id="login" action="{{ route('register.store') }}" method="POST"
                                        ...
                                        <p>If you have an account with us, please <a href="{{ route('login.view') }}">log in</a>.</p>
        ...
        <footer class="site-footer "
            style="background-image: url(images/background/bg2.jpg); background-size: cover;">
            <!-- Footer Top Part -->
