...
<div id="loading-area">
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-between" id="navbarNavDropdown">
                        ...
                        <ul class="nav navbar-nav nav1">	
							<li class="active"><a href="javascript:void(0);">Home<i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									<li><a href="index.html">Home - Pizza & Burger</a></li>
									<li><a href="index-2.html">Home - Cake Bakery</a></li>
        ...
        <div class="content-block">
				...
				<div class="item">
					<div class="slide" style="background-image:url(images/main-slider/slide1.jpg);">
						<div class="content">
							...
							<a href="javascript:void(0);" class="btn white" data-toggle="modal" data-target="#exampleModal">Subscribe Now</a>
						</div>
					</div>
				</div>
				<div class="item">
			...
			<div class="modal fade subscribe-box" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<form action="https://restroking.dexignzone.com/xhtml/script/mailchamp.php" class="dzSubscribe modal-content" method="post">
			...
			<!-- Services -->
			<div class="section-full content-inner-3" style="background-image:url(images/background/bg5.jpg);  background-size:100%;">
				<div class="container">
					<div class="row service-area1">
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="icon-bx-wraper text-center service-box1" style="background-image: url(images/our-services/pic1.jpg)">
								<div class="icon-content">
									<h2 class="dlab-tilte text-white">Macarons</h2>
									<p>Lorem Ipsum is simply</p>
									<div class="dlab-separator style1 bg-primary"></div>
									<a href="shop-product-details.html" class="btn btnhover">More details <i class="fa fa-angle-double-right m-l5"></i></a>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="icon-bx-wraper text-center service-box1" style="background-image: url(images/our-services/pic2.jpg)">
								<div class="icon-content">
						...
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="icon-bx-wraper text-center service-box1" style="background-image: url(images/our-services/pic3.jpg)">
								<div class="icon-content">
						...
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
							<div class="icon-bx-wraper text-center service-box1" style="background-image: url(images/our-services/pic4.jpg)">
								<div class="icon-content">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="section-head mb-0 text-center">
								...
								<p class="main-text">Join DexignZone <strong>Bakery</strong>™ to earn Gold level benefits like free Cakes and food, get free refills, pay and order with your phone, and more.</p>
								<p>Exclusive deals on Cakes, delivered straight to your inbox <a href="javascript:void(0);">Join Now</a></p>
							</div>
						</div>
					</div>
				</div>
			...
			<!-- Services End -->
			<!-- About Services -->
			<div class="section-full content-inner service-area2 bg-img-fix bg-line-top bg-line-bottom" style="background-image: url(images/background/bg4.jpg);  background-size: cover;">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="section-head text-center">
								<h2 class="text-white">What Do We Offer For You?</h2>
								<p class="text-bold">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
								<div class="dlab-separator style1 bg-primary"></div>
							</div>
						</div>
					</div>
							...
							<div class="row p-l30">
								<div class="col-lg-6 col-sm-6 m-b30">
									<div class="icon-bx-wraper text-white service-box2">
										<div class="icon-bx">
											<a href="javascript:void(0);" class="icon-cell"><img src="images/icons/service-icon/icon2.png" alt=""></a>
										</div>
										<div class="icon-content">
								...
								<div class="col-lg-6 col-sm-6 m-b30">
									<div class="icon-bx-wraper text-white service-box2">
										<div class="icon-bx">
											<a href="javascript:void(0);" class="icon-cell"><img src="images/icons/service-icon/icon3.png" alt=""></a> 
										</div>
										<div class="icon-content">
								...
								<div class="col-lg-6 col-sm-6 m-b30">
									<div class="icon-bx-wraper text-white service-box2">
										<div class="icon-bx">
											<a href="javascript:void(0);" class="icon-cell"><img src="images/icons/service-icon/icon4.png" alt=""></a> 
										</div>
										<div class="icon-content">
								...
								<div class="col-lg-6 col-sm-6 m-b30">
									<div class="icon-bx-wraper text-white service-box2">
										<div class="icon-bx">
											<a href="javascript:void(0);" class="icon-cell"><img src="images/icons/service-icon/icon5.png" alt=""></a> 
										</div>
										<div class="icon-content">
								...
								<div class="col-lg-6 col-sm-6 m-b30">
									<div class="icon-bx-wraper text-white service-box2">
										<div class="icon-bx"> 
											<a href="javascript:void(0);" class="icon-cell"><img src="images/icons/service-icon/icon1.png" alt=""></a> 
										</div>
										<div class="icon-content">
			...
			<!-- About Services End -->
			<!-- Faq And Our Info -->
			<div class="section-full content-inner bg-gray" style="background-image:url(images/background/bg1.jpg);  background-size:100%;">
				<div class="container">
						...
						<div class="col-lg-6 m-b30">
							<div class="m-r20">
								...
								<div class="clearfix">
									...
									<p class="text">First and foremost I am a chef, whether behind the stove at one of my Northern California restaurants or for the past 15 years in front of the Lorem Ipsum is simply <strong>Bakery</strong> dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took.</p>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley.</p>
									<a href="faq.html" class="btn btn-md btnhover shadow m-t30"><i class="fa fa-angle-right m-r10"></i>Get Started</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6 m-b30">
							<div class="dlab-accordion faq-style1" id="accordion001">
								<div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											<a href="javascript:void(0);" data-toggle="collapse" data-target="#collapse1" aria-expanded="true"> 
								...
								<div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											<a href="javascript:void(0);" data-toggle="collapse" data-target="#collapse2" class="collapsed" aria-expanded="false">
								...
								<div class="panel">
									<div class="acod-head">
										<h6 class="acod-title"> 
											<a href="javascript:void(0);" data-toggle="collapse" data-target="#collapse3" class="collapsed" aria-expanded="false">
					...
					<div class="row m-lr0 about-area1">
						...
						<div class="col-lg-6 p-lr0 d-flex align-items-center text-center">
							<div class="about-bx">
								...
								<a href="about-1.html" class="btn-secondry white btnhover btn-md"><i class="fa fa-cart"></i>GET NOW</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container content-inner">
					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="blog-post blog-grid blog-rounded">
                                <div class="dlab-post-media dlab-img-effect"> 
									<a href="blog-single-sidebar.html"><img src="images/blog/grid/pic1.jpg" alt=""></a> 
								</div>
                                <div class="dlab-info p-a25">
									<div class="dlab-post-title">
                                        <h4 class="post-title"><a href="blog-single-sidebar.html">Understand The Background Of Bakery Now.</a></h4>
                                    </div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="blog-post blog-grid blog-rounded">
                                <div class="dlab-post-media dlab-img-effect"> 
									<a href="blog-single-sidebar.html"><img src="images/blog/grid/pic2.jpg" alt=""></a> 
								</div>
                                <div class="dlab-info p-a25">
                                    <div class="dlab-post-title">
                                        <h4 class="post-title"><a href="blog-single-sidebar.html">Seven Reliable Sources To Learn About Bakery.</a></h4>
                                    </div>
									<div class="dlab-post-meta ">
                                        <ul>
											<li class="post-folder">
						...
						<div class="col-lg-4 col-md-6">
							<div class="blog-post blog-grid blog-rounded">
                                <div class="dlab-post-media dlab-img-effect"> 
									<a href="blog-single-sidebar.html"><img src="images/blog/grid/pic3.jpg" alt=""></a> 
								</div>
                                <div class="dlab-info p-a25">
                                    <div class="dlab-post-title">
                                        <h4 class="post-title"><a href="blog-single-sidebar.html">Ten Places That You Can Find Bakery.</a></h4>
                                    </div>
									<div class="dlab-post-meta">
										<ul>
											<li class="post-folder">
    ...
    <footer class="site-footer " style="background-image: url(images/background/bg2.jpg); background-size: cover;">
							...
							<div class="widget-post-bx">
								<div class="widget-post clearfix">
									...
									<div class="dlab-post-info">
										...
										<div class="dlab-post-meta">
											<ul>
												<li class="post-date"> <i class="la la-clock-o"></i><strong>March 25, 2023</strong> </li>
											</ul>
										</div>
									</div>
								</div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 text-left"> <span>Copyright © 2023 DexignZone. all rights reserved.</span> </div>
...
// 	//setCookie('themeFullColor_value','css/skin/skin-2',1);
// 	//setCookie('logo_value','images/logo-2.png',1);
