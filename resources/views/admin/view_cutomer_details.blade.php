                    ...
                    <div class="container">
                        <div class="row">
                            <div class="mb-3 d-flex w-100">
                                ...
                                <div class="w-50">{{ $customerDetail->firstname . ' ' . $customerDetail->lastname }}</div>
                            </div>
                            <div class="mb-3 d-flex w-100">
                                <div class="w-25">Email</div>
                                <div class="w-50">{{ $customerDetail->email }}</div>
                            </div>
                            <div class="mb-3 d-flex w-100">
                                <div class="w-25">Contact No</div>
                                <div class="w-50">{{ $customerDetail->contact_no }}</div>
                            </div>
                            <div class="mb-3 d-flex w-100">
